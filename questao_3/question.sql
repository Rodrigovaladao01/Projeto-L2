...
-- SELECIONAR O NOME,DIA DO MES E O VALOR DA PARCELA DE TODOS OS CONTRATOS QUE ESTÃO EM ATRASO
...
-- SELECIONAR O NOME, O VALOR DA PARCELA E A QUANTIDADE DE PARCELAS DE TODOS OS CONTRATOS QUE ESTÃO EM DIA
